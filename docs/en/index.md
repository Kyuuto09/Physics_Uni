...
1.  **Forking the Repository**:
    - Go to the source repository: [https://github.com/nowitends/Physics_Problems](https://github.com/nowitends/Physics_Problems)
...
3.  **Creating Documentation**:
    ...
    - Each task file (e.g., `01_Mechanics_1.md`) has a dedicated solutions file in `Your_solutions_all/` (e.g., `Your_solutions_all/01_Mechanics_1.md`).
    - These files are your **workspace** - this is where you create and maintain Markdown solutions, proofs, and theoretical notes.
    - The structure is pre-prepared: each solutions file already contains the task statements, so add your work under each task heading.
    ...
    - If you need extra materials (graphics, charts, HTML/JS files, input data, simulation results), create a subfolder next to the related solutions file inside `Your_solutions_all`. Keep solutions in the main file and assets in clearly named subfolders.
